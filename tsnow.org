...
You will also need to change the values for the location of bibtex
 ...
 settings. *Search for 'tsnow' in this file* to find the paths that
...
*** XeLaTeX and pdfLaTeX Export Settings
   ...
   setup in each case. There is a good deal of local stuff in this section. The required style files used below are available at https://github.com/tsnow/latex-custom-kjh. You may need to adjust or remove some of these settings depending on your
